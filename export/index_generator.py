...
.stock-list-table .sort-button{display:inline-flex;align-items:center;gap:4px;background:none;border:0;
  padding:0;font-family:var(--mono);font-size:.62rem;font-weight:700;letter-spacing:.05em;text-transform:uppercase;
  color:var(--ink-3);cursor:pointer}
.stock-list-table thead th.num .sort-button{margin-left:auto}
.stock-list-table .sort-button::after{content:"↕";color:var(--ink-3);font-size:.6rem}
...
.stock-list-table tbody td{padding:8px 10px;border-bottom:1px solid var(--border);font-size:.82rem}
...
.stock-item .si-id{font-family:var(--mono);color:var(--ink-3);font-size:.68rem;margin-right:8px}
.stock-item .si-name{font-family:var(--serif);font-weight:600;color:var(--ink);font-size:.86rem}
